...
class GraficoHistorico extends StatefulWidget {
  Ativo ativo;
  GraficoHistorico({Key? key, required this.ativo}) : super(key: key);
...
class _GraficoHistoricoState extends State<GraficoHistorico> {
  ...
  late AtivoRepository repositorio;
  ...
  setDados() async {
    ...
    if (historico.isEmpty)
      historico = await repositorio.getHistoricoMoeda(widget.ativo);
  ...
  Widget build(BuildContext context) {
    repositorio = context.read<AtivoRepository>();
